...
const WORD_NORMALIZATION = new Map([['llms', 'llm'], ['models', 'model'], ['meetups', 'meetup'], ['agents', 'agent']]);
const WORD_DISPLAY = new Map([['llm', 'LLM/LLMs'], ['model', 'model/models'], ['meetup', 'meetup/meetups'], ['agent', 'agent/agents']]);
